...
x1, y1 = diff_equations.method_of_euler_third_order(multifunction, 100, 0, 5, 1, 1, 1 / 2)
x2, y2 = diff_equations.method_of_euler_third_order(multifunction, 100, 0, 5, 1, 1 / 2, 1)
x3, y3 = diff_equations.method_of_euler_third_order(multifunction, 100, 0, 5, 1, 1, 2)
x4, y4 = diff_equations.method_of_euler_third_order(multifunction, 100, 0, 5, 1, 2 / 3, 1 / 3)
