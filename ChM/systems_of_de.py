def method_of_euler(multifunction1, multifunction2, n, a, b, y10, y20, epsilon=None):
    if epsilon == None:
        ...
        for i in range(n):
            t.append(t[i] + h)
            y1.append(y1[i] + multifunction1(y1[i], y2[i]) * h)
            y2.append(y2[i] + multifunction2(y1[i], y2[i]) * h)
        return t, y1, y2
    else:
        i = 1
        while True:
...
def method_of_euler_second_order(multifunction1, multifunction2, n, a, b, y10, y20, epsilon=None):
    if epsilon == None:
        ...
        for i in range(n):
            t.append(t[i] + h)
            k11.append(multifunction1(y1[i], y2[i]) * h)
            k21.append(multifunction2(y1[i], y2[i]) * h)
            k12.append(multifunction1(y1[i] + k11[i] / 2, y2[i] + k21[i] / 2) * h)
            k22.append(multifunction2(y1[i] + k11[i] / 2, y2[i] + k21[i] / 2) * h)
...
def method_of_euler_third_order(multifunction1, multifunction2, n, a, b, y10, y20, epsilon=None):
    if epsilon == None:
        ...
        for i in range(n):
            ...
            k12.append(multifunction1(y1[i] + k11[i] / 2, y2[i] + k21[i] / 2) * h)
            k22.append(multifunction2(y1[i] + k11[i] / 2, y2[i] + k21[i] / 2) * h)
            k13.append(multifunction1(y1[i] + k12[i] / 2, y2[i] + k22[i] / 2) * h)
            k23.append(multifunction2(y1[i] + k12[i] / 2, y2[i] + k22[i] / 2) * h)
...
def method_of_euler_fourth_order(multifunction1, multifunction2, n, a, b, y10, y20, epsilon=None):
    if epsilon == None:
        ...
        for i in range(n):
            ...
            k13.append(multifunction1(y1[i] + k12[i] / 2, y2[i] + k22[i] / 2) * h)
            k23.append(multifunction2(y1[i] + k12[i] / 2, y2[i] + k22[i] / 2) * h)
            k14.append(multifunction1(y1[i] + k13[i] / 2, y2[i] + k23[i] / 2) * h)
            k24.append(multifunction2(y1[i] + k13[i] / 2, y2[i] + k23[i] / 2) * h)
